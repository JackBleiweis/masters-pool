...
export const draftDigestParagraphs: Record<string, string[]> = {
  ...
  Seth: [
    ...
    'Leishman and Ancer close with complementary skill sets: Leishman’s short game and experience-driven scoring versus Ancer’s compact driving and wedge precision. Both carry field-makeup questions any given week, but the model respects their paths to four-day stability if they avoid big early miss cycles.',
  ],
  'Linda & Lawrence': [
